...
export default function AIWriter() {
  const canonicalUrl = typeof window !== "undefined" ? `${window.location.origin}/ai-writer` : "/ai-writer";

  const keywords = ["ai writer", "ai article writer", "seo writer", "content writer ai", "long form ai content"];
  const jsonLd = [{"@context": "https://schema.org", "@type": "SoftwareApplication", "name": "SEOScribe AI Writer that Mirrors Search Intent", "applicationCategory": "BusinessApplication", "operatingSystem": "Web", "offers": {"@type": "Offer", "price": "24.00", "priceCurrency": "USD"}, "aggregateRating": {"@type": "AggregateRating", "ratingValue": "4.8", "reviewCount": "187"}, "areaServed": "US, Global"}];
    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <header className="py-14 border-b">
        <div className="max-w-6xl mx-auto px-4">
          <h1 className="text-3xl sm:text-5xl font-bold">AI Writer</h1>
