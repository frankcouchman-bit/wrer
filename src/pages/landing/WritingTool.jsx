...
export default function WritingTool() {
  const canonicalUrl = typeof window !== "undefined" ? `${window.location.origin}/writing-tool` : "/writing-tool";

  const keywords = ["writing tool", "seo writing tool", "content generator", "long form writer tool", "ai content writing tool"];
  const jsonLd = [{"@context": "https://schema.org", "@type": "SoftwareApplication", "name": "SEOScribe SEO Writing Tool for Authority-Building Content", "applicationCategory": "BusinessApplication", "operatingSystem": "Web", "offers": {"@type": "Offer", "price": "24.00", "priceCurrency": "USD"}, "aggregateRating": {"@type": "AggregateRating", "ratingValue": "4.8", "reviewCount": "187"}, "areaServed": "US, Global"}];
    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <header className="py-14 border-b">
        <div className="max-w-6xl mx-auto px-4">
          <h1 className="text-3xl sm:text-5xl font-bold">Writing Tool</h1>
